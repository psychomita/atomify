...
export default function ProjectileMotionSimulation() {
  ...
  }, [isRunning, angle, velocity, gravity, height, scaleFactor]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  }, [height, scaleFactor, theme]); // eslint-disable-line react-hooks/exhaustive-deps
