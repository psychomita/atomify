...
export default function PendulumSimulation() {
  ...
  }, [isRunning, angle, angularVelocity, length, gravity, damping]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  useEffect(() => {
    drawPendulum()
  }, [length, angle, theme]); // eslint-disable-line react-hooks/exhaustive-deps
