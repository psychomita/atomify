...
export default function PHMeasurementSimulation() {
  ...
  // Indicators
  const indicators: { [key: string]: Indicator } = useMemo(() => ({
    universal: {
  ...
  const updateSolution = (property: string, value: string | number) => {
    if (!selectedSolution) return;
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setNewSolutionType(value as "acid" | "base" | "salt" | "buffer")}
                  >
