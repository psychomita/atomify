...
export default function GasLawsSimulation() {
  ...
  useEffect(() => {
    resetSimulation();
  }, [particleCount, gasType]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  }, [isRunning, particles, temperature, containerWidth, containerHeight]); // eslint-disable-line react-hooks/exhaustive-deps
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <Tabs
                  defaultValue="boyle"
                  value={selectedLaw}
                  onValueChange={(value) => handleLawChange(value as "boyle" | "charles" | "gay-lussac" | "combined")}
                >
              ...
              <div className="space-y-2">
                ...
                <Select value={gasType} onValueChange={(value) => setGasType(value as "air" | "helium" | "co2")}>
                  <SelectTrigger>
