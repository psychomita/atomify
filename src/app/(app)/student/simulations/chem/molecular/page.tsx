...
function MolecularStructuresSimulation() {
  ...
  // Molecule library
  const molecules: { [key: string]: Molecule } = useMemo(() => ({
    water: {
      name: "Water (H₂O)",
      atoms: [
  ...
  }, [selectedMolecule, rotationX, rotationY, rotationZ, zoom, showLabels, showBonds, bondThickness, molecules])
      ...
      <Card className="w-full h-full">
        ...
        <CardContent className="flex flex-col items-center">
          ...
          <div className="mt-4 text-sm text-gray-500 w-full">
            ...
            <Slider value={[zoom]} min={40} max={200} step={10} onValueChange={(value: React.SetStateAction<number>[]) => setZoom(value[0])} />
          </div>
            ...
            <div>
              ...
              <div className="space-y-2 mt-2">
                ...
                <Slider
                  ...
                  max={10}
                  step={1}
                  onValueChange={(value: React.SetStateAction<number>[]) => setBondThickness(value[0])}
                  disabled={!showBonds}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  max={90}
                  step={5}
                  onValueChange={(value: React.SetStateAction<number>[]) => setRotationX(value[0])}
                />
              </div>
              ...
              <div className="space-y-2 mt-2">
                ...
                <Slider
                  ...
                  max={360}
                  step={5}
                  onValueChange={(value: React.SetStateAction<number>[]) => setRotationY(value[0])}
                />
              </div>
              ...
              <div className="space-y-2 mt-2">
                ...
                <Slider
                  ...
                  max={360}
                  step={5}
                  onValueChange={(value: React.SetStateAction<number>[]) => setRotationZ(value[0])}
                />
              </div>
            </div>
          </div>
